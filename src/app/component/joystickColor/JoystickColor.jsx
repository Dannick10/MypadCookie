...
const JoystickColor = ({ player, items }) => {
  ...
  return (
    ...
    >
        <section className="w-full h-20 bg-gray-700" style={{background: player._gamepad.colors.screen}}>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center w-12">
          <div className="flex items-center justify-center w-full">
            <div className="bg-orange-600 w-4 h-4 rounded-full items-center justify-center flex"style={{background: colors.buttonY}}>
              <p className="text-white text-sm">Y</p>
            </div>
          </div>
          <div className="flex items-center justify-between w-full">
            <div className="bg-red-700 w-4 h-4 rounded-full flex items-center justify-center"style={{background: colors.buttonX}}>
              <p className="text-white text-sm">X</p>
            </div>
            <div className="bg-blue-700 w-4 h-4 rounded-full flex items-center justify-center"style={{background: colors.buttonB}}>
              <p className="text-white text-sm">B</p>
            </div>
          </div>
          <div className="flex items-center justify-center w-full">
            <div className="bg-green-700 w-4 h-4 rounded-full flex items-center justify-center"style={{background: colors.buttonA}}>
